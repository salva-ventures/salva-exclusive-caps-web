        ...
        >
          ...
          >
            ...
            >
              ...
              DiseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±o, presencia y carÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡cter
            </motion.div>
            ...
            >
              {[
                ...
                { label: "AtenciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n", value: "Directa por WhatsApp" },
              ].map((item) => (
                <motion.div
                  key={item.label}
                  variants={fadeUp}
        ...
        >
          <motion.div variants={fadeUp} className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-5xl">
              Disponibilidad y envÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­os
            </h2>
            <p className="mt-5 text-base leading-8 text-white/72 sm:text-lg">
              Entrega inmediata en {DELIVERY_INFO.immediate.join(", ")}. EnvÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­os
              nacionales e internacionales con cotizaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n por separado. Toda
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              {[
                "Entrega inmediata",
                "ConfirmaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n por WhatsApp",
            ...
            <div className="mt-8">
              <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.985 }}>
                ...
                >
                  Ver detalles de envÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­o
                </Link>
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div variants={staggerContainer} className="grid gap-4">
            {[
              ...
              },
              {
                ...
                description:
                  "Sujeta a existencias y confirmaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n directa por WhatsApp.",
              },
              {
                title: "EnvÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­os",
                description:
        ...
        >
          <motion.div variants={fadeUp} className="max-w-2xl">
            <p className="mb-3 text-xs uppercase tracking-[0.4em] text-red-600">
              ColecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n
            </p>
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-white md:text-4xl">
              Productos destacados
            </h2>
            <p className="leading-relaxed text-white/55">
              Una selecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de modelos representativos de la propuesta de{" "}
              {BRAND.name}, con diseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±o, presencia y carÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡cter.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              Ver catÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡logo completo
          ...
          <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
            <motion.div variants={fadeUp} className="order-2 md:order-1">
              ...
              >
                <p className="mb-3 text-xs uppercase tracking-[0.35em] text-red-600">
                  Nuestra visiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n
                </p>
                <h3 className="mb-4 text-2xl font-bold text-white">
                  Construir una marca referente en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico
                </h3>
                <p className="mb-6 text-sm leading-relaxed text-white/55">
                  Posicionar a {BRAND.name} como una marca referente en gorras
                  premium dentro de MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico, combinando diseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±o, identidad, orden
            ...
            <motion.div variants={fadeUp} className="order-1 md:order-2">
              ...
              <h2 className="mb-6 text-3xl font-bold tracking-tight text-white md:text-4xl">
                Identidad, diseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±o y confianza
              </h2>
              <p className="leading-relaxed text-white/55">
                Somos una marca mexicana enfocada en ofrecer gorras premium con
                identidad propia. Apostamos por una imagen sÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³lida, una operaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n
                seria y una propuesta pensada para clientes que valoran estilo,
                exclusividad y atenciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n directa.
              </p>
            </motion.div>
          </div>
        </motion.div>
      ...
      <section className="relative border-y border-white/10 bg-[#0a0a0a] py-16 lg:py-24">
        ...
        >
          ...
          <div className="space-y-4">
            {[
              {
                q: "ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³mo puedo realizar un pedido?",
                a: "ContÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ctanos directamente por WhatsApp seleccionando el producto que te interesa. AhÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ confirmamos disponibilidad, pago y entrega.",
              },
              {
                q: "ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³mo manejan entregas y envÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­os?",
                a: `Entrega inmediata en ${DELIVERY_INFO.immediate.join(", ")}, sujeta a existencias y coordinaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n directa. TambiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©n realizamos envÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­os nacionales e internacionales con costo extra.`,
              },
              {
                q: "ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿Las fotos corresponden al producto real?",
                a: "SÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­. Las fotografÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­as del catÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡logo corresponden a los modelos reales disponibles.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
            ...
            <div className="grid gap-8 md:grid-cols-[1.15fr_0.85fr] md:items-center">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-sm leading-7 text-white/60 sm:text-base">
                  ...
                  negocio, conoce nuestra atenciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n personalizada para mayoreo.
              ...
              <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-1">
                {[
                  "AtenciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n personalizada",
                  "Compra por volumen",
                  "SelecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de modelos segÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºn negocio",
                  "EnvÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­os nacionales e internacionales",
                ].map((item) => (
                  <div
                    key={item}
          ...
          >
            ...
            <div className="relative">
              ...
              <h2 className="text-3xl font-bold tracking-tight text-white md:text-5xl">
                ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿Listo para elegir tu prÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³xima gorra?
              </h2>
              <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-white/60">
                Explora el catÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡logo o recibe atenciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n directa por WhatsApp para
                confirmar disponibilidad, entrega o envÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­o.
              </p>
              ...
              >
                {[
                  "Entrega inmediata",
                  "AtenciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n directa",
                  "EnvÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­os nacionales e internacionales",
                ].map((item) => (
                  <motion.div
                    key={item}
