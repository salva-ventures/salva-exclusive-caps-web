  ...
  return (
    <div className="min-h-screen bg-black">
      <motion.section
        ...
        className="border-b border-white/10 bg-[radial-gradient(circle_at_top,rgba(220,38,38,0.12),transparent_34%),linear-gradient(to_bottom,#090909,#050505)] px-4 py-16 md:py-20"
      >
      ...
      <section className="px-4 py-8 md:py-10">
        <div className="mx-auto max-w-7xl">
          <motion.div
            ...
            className="sticky top-20 z-30 mb-8 rounded-2xl border border-white/10 bg-black/70 p-3 backdrop-blur-xl md:p-4"
          >
              ...
              <div className="flex flex-col gap-3 lg:flex-row">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-white/[0.04] py-3 pl-11 pr-4 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-red-600/70 focus:bg-white/[0.06]"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:flex lg:w-auto">
                  <div className="relative min-w-[190px]">
                    <select
                      ...
                      className="w-full appearance-none rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 pr-10 text-sm text-white outline-none transition-all duration-300 focus:border-red-600/70"
                    >
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-white transition-all duration-300 hover:border-white/25 hover:bg-white/[0.07] lg:hidden"
                  >
...
function FilterSection({
  ...
  return (
    <motion.div layout className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <motion.button
              ...
              className={`rounded-full border px-3 py-2 text-[11px] uppercase tracking-[0.2em] transition-all duration-300 ${
                isActive
                  ...
                  : "border-white/10 bg-white/[0.02] text-white/70 hover:border-white/30 hover:bg-white/[0.05] hover:text-white"
              }`}
            >
              {option}
            </motion.button>
