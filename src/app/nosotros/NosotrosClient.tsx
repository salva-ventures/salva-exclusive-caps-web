    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          variants={staggerContainer}
          className="relative grid grid-cols-1 gap-10 lg:grid-cols-[0.95fr_1.05fr]"
        >
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {team.map((person) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                transition={{ type: "spring", stiffness: 240, damping: 22 }}
                className={`${panelClass} ${panelOverlay} bg-[#111] p-8`}
              >
                <div className="pointer-events-none absolute inset-0 rounded-[1.75rem] ring-1 ring-inset ring-white/[0.03]" />
                <div className="relative">
                  <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl border border-red-600/30 bg-red-600/10 shadow-[0_8px_20px_rgba(220,38,38,0.08)]">
      ...
      <section className="relative border-y border-white/10 bg-[#080808] py-20">
        <div className="absolute inset-0 opacity-[0.02] [background-image:radial-gradient(rgba(255,255,255,0.9)_0.6px,transparent_0.6px)] [background-size:22px_22px]" />
        <motion.div
          initial="hidden"
          whileInView="show"
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {values.map((value) => (
              <motion.div
                ...
                variants={fadeUp}
                whileHover={{ y: -4 }}
                className={`${panelClass} ${panelOverlay} bg-[#111] p-6 md:p-7`}
              >
